...
const projects = [
  {
    id: 8,
    title: "PrepMate AI",
    description: "AI-powered interview preparation platform that helps users practice mock interviews, generate answers, review resumes, and create content using Google Gemini integration.",
    image: "/projects/project8.png",
    video: "",
    tags: ["MERN Stack", "Prompt Engineering", "Google Gemini", "LLM", "Open Source"],
    demoUrl: "https://prepmate-ai-six.vercel.app/",
    githubUrl: "https://github.com/riteshgarna12/PrepMate-Ai1",
    featured: true,
    accentColor: "from-emerald-500 to-teal-600",
    status: "Live",
    highlights: ["AI mock interviews", "Resume review", "Content generation", "Blog & article writer"]
  },
  {
    id: 7,
    title: "CyberSecurity Services",
    description: "A cybersecurity-focused platform offering secure user management, threat monitoring, and protected access systems for organizations.",
    ...
    accentColor: "from-emerald-500 to-teal-600",
    status: "Live",
    highlights: ["Secure authentication", "Role-based access", "Data protection", "Threat monitoring"]
  },
  {
    id: 1,
    title: "HappyHampers",
    description: "An online gifting and fashion marketplace where users can explore curated hampers, discover trending products, and enjoy a seamless shopping experience.",
    image: "/projects/project1.png",
    video: "",
    tags: ["React", "Node.js", "JavaScript", "Express.js"],
    demoUrl: "#",
    githubUrl: "#",
    featured: true,
    accentColor: "from-purple-500 to-indigo-600",
    status: "Live",
    highlights: ["Curated hampers", "Product catalog", "Shopping cart", "Smooth checkout"]
  },
  {
    id: 2,
    title: "Ecommerce Brand Site",
    description: "A modern eCommerce platform designed for brands to showcase products, manage inventory, and deliver a smooth shopping experience.",
    image: "/projects/project2.png",
    video: "",
    tags: ["React", "MongoDB", "Node.js", "WebRTC"],
    demoUrl: "#",
    githubUrl: "https://github.com/riteshgarna12/E-ecommerce",
    featured: true,
    accentColor: "from-blue-500 to-cyan-600",
    status: "Live",
    highlights: ["Product showcase", "User authentication", "Responsive UI", "Order management"]
  },
  {
    id: 3,
    title: "Gym Management System",
    description: "A fitness management platform that helps gyms handle memberships, track workouts, manage schedules, and provide users with structured fitness plans.",
    image: "/projects/project3.png",
    video: "",
    tags: ["Next.js", "Gemini AI", "Clerk Auth", "Redis"],
    demoUrl: "https://fitnove.vercel.app/",
    githubUrl: "https://github.com/riteshgarna12/Gym-Management-System",
    accentColor: "from-amber-500 to-orange-600",
    status: "Live",
    highlights: ["Workout tracking", "Membership management", "Scheduling", "Fitness plans"]
  },
  {
    id: 4,
    title: "Spendlix",
    description: "A personal finance management tool that enables users to track expenses, analyze spending patterns, and plan budgets effectively.",
    image: "/projects/project4.png",
    video: "",
    tags: ["React", "Chart.js", "Node.js", "Firebase"],
    demoUrl: "https://spendlix.vercel.app/login",
    githubUrl: "https://github.com/riteshgarna12/Spendlix",
    accentColor: "from-rose-500 to-pink-600",
    status: "Live",
    highlights: ["Expense tracking", "Visual analytics", "Budget planning", "Financial insights"]
  },
  {
    id: 5,
    title: "Echonest",
    description: "A digital journaling and storytelling platform where users can capture travel memories, write personal stories, and relive experiences.",
    image: "/projects/project5.png",
    video: "",
    tags: ["React", "Redux", "Mapbox", "Stripe"],
    demoUrl: "#",
    githubUrl: "https://github.com/riteshgarna12/ECHONEST-main",
    accentColor: "from-violet-500 to-purple-600",
    status: "Live",
    highlights: ["Travel stories", "Diary writing", "Memory tracking", "Interactive maps"]
  },
  {
    id: 6,
    title: "PhotoPro",
    description: "A platform for photographers and production teams to collaborate, manage projects, and handle client bookings efficiently.",
    ...
    status: "Development",
    highlights: ["Team collaboration", "Project management", "Client bookings", "Portfolio showcase"]
  }
];
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href="https://github.com/riteshgarna12"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
