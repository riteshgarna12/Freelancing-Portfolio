...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/riteshgarna10903/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://www.instagram.com/ritesh_garna1020/", label: "Instagram" },
    { icon: <Github size={18} />, href: "https://github.com/riteshgarna12", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "sainiritesh492@gmail.com", href: "mailto:sainiritesh492@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 9352695006", href: "tel:+919352695006" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">RITESH GARNA</h3>
