...
export const TestimonialSection = () => {
  ...
  const testimonials = [
  {
    id: 1,
    name: "Emma Williams",
    role: "Product Director at NexaTech (USA)",
    content: `Working with Ritesh was seamless from day one. Not only did he deliver a full-stack solution ahead of schedule, but he also communicated clearly throughout the project. It's rare to find a developer who understands both the tech and the business side so well.`,
    rating: 5,
    image: "#"
  },
  {
    id: 2,
    name: "Arjun Mehta",
    role: "Founder at InnovateX (India)",
    content: `Ritesh brought our vision to life with incredible precision. His attention to detail and problem-solving skills made a huge difference in our product's success. The performance and scalability of the app exceeded our expectations.`,
    rating: 5,
    image: "#"
  },
  {
    ...
    role: "Senior UX Designer at DesignFlow (Spain)",
    content: `I've reviewed hundreds of portfolios, and Ritesh's work is truly exceptional. The way animations guide attention while maintaining performance is masterful. The UI feels modern, clean, and highly intuitive.`,
    rating: 5,
    image: "#"
  },
  {
    id: 4,
    name: "Rahul Sharma",
    role: "CTO at Startup Ventures (India)",
    content: `From wireframes to deployment, Ritesh handled everything with confidence and creativity. The final product is fast, reliable, and visually impressive. I wouldn’t hesitate to work with him again.`,
    rating: 5,
    image: "#"
  }
  ];
