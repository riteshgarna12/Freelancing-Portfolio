...
export const AboutSection = () => {
  ...
  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/riteshgarna12" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/riteshgarna10903/" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:sainiritesh492@gmail.com" }
  ];
  ...
  const tabContent = {
    ...
    professional: "With 2+ years in full-stack development, I've delivered 15+ successful projects using modern technologies. I specialize in scalable architecture and performance optimization.",
  ...
  const handleDownload = () => {
    ...
    link.href = '/ritesh-resume.pdf'; // Must be in public folder
    link.download = 'ritesh-resume.pdf';
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/image.png" alt="Ritesh" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Ritesh Garna</h2>
